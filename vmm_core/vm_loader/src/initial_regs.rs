...
pub fn x86_initial_regs(
    ...
    for &reg in init {
        match reg {
            ...
            X86Register::MtrrDefType(v) => state.mtrrs.msr_mtrr_def_type = v,
            X86Register::MtrrPhysBase0(v) => state.mtrrs.variable[0] = v,
            X86Register::MtrrPhysMask0(v) => state.mtrrs.variable[1] = v,
            X86Register::MtrrPhysBase1(v) => state.mtrrs.variable[2] = v,
            X86Register::MtrrPhysMask1(v) => state.mtrrs.variable[3] = v,
            X86Register::MtrrPhysBase2(v) => state.mtrrs.variable[4] = v,
            X86Register::MtrrPhysMask2(v) => state.mtrrs.variable[5] = v,
            X86Register::MtrrPhysBase3(v) => state.mtrrs.variable[6] = v,
            X86Register::MtrrPhysMask3(v) => state.mtrrs.variable[7] = v,
            X86Register::MtrrPhysBase4(v) => state.mtrrs.variable[8] = v,
            X86Register::MtrrPhysMask4(v) => state.mtrrs.variable[9] = v,
            X86Register::MtrrFix64k00000(v) => state.mtrrs.fixed[0] = v,
            X86Register::MtrrFix16k80000(v) => state.mtrrs.fixed[1] = v,
            X86Register::MtrrFix4kE0000(v) => state.mtrrs.fixed[7] = v,
            X86Register::MtrrFix4kE8000(v) => state.mtrrs.fixed[8] = v,
            X86Register::MtrrFix4kF0000(v) => state.mtrrs.fixed[9] = v,
            X86Register::MtrrFix4kF8000(v) => state.mtrrs.fixed[10] = v,
        }
    }
